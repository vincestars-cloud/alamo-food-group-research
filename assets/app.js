...
const products = [
  { id:1, name:'Queso Oaxaca', nameEs:'Queso Oaxaca', cat:'dairy', price:4.25, unit:'/lb', badge:'popular', desc:'Traditional string cheese for quesadillas & fundido', descEs:'Queso de hebra tradicional para quesadillas y fundido' },
  ...
  grid.innerHTML = list.map(p => `
    <div class="product-card reveal visible">
      <div class="p-img">${p.badge ? `<span class="p-badge badge-${p.badge}">${p.badge}</span>` : ''}
        <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#ccc" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="3"/><path d="M3 16l5-5 4 4 4-6 5 7"/></svg>
      </div>
      <div class="p-body">
